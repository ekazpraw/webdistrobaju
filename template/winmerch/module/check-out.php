...
<table width="559" height="217" align="center" cellpadding="0" cellspacing="4">
  <tr><?php echo"
    ...
    <p align=right><strong><right><input type=button onclick=window.location='index.php?module=cart' class='button green' name='ubah' id='ubah' value='Ubah Order'></right></strong></p></td>
  </tr>
</table>";
