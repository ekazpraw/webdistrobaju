...
<br><br>
<table width="560" height="433" cellpadding="10" align="center" cellspacing="0" border="0" style="border-style:solid;border-width:thin;border-color:#DFDFDF;">
  <tr>
    <td width="560" height="238" scope="col"><table width="560" height="223" cellpadding="0" cellspacing="0">
      <tr>
		<th height="5" colspan="1" scope="col"><img src="/winmerch/admin/img/logo1.jpg"></th>
        <th height="44" colspan="2" scope="col"><font size="3">DATA PEMBELI</font></th>
		<th height="5" colspan="3" scope="col"><img src="/winmerch/admin/img/logo2.png"></th>
      </tr>
      <tr align="left">
...
<p align="right">
<input type="button" onclick="window.location='/winmerch/admin/module/print.php?id=<?php echo $id ?>'" target="a_blank" class="button blue" name="Cetak" id="Cetak" value="Cetak"></p>
</td>
  </tr>
</table>