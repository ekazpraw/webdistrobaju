...
<tr>
    ...
    <table width="800" height="57" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr class="tabel">
        <th width="120" bgcolor="#575757" scope="col" height="36">Produk </th>
        <th width="45" bgcolor="#575757" scope="col">Harga </th>
  ...
  <?php
// Tampil Data //
	$sql_tampil=mysql_query("select *from t_produk order by tgl_post DESC limit ".$MulaiAwal.",".$BatasAwal."");
...
".substr($deskripsi_produk,0,75)." .......</td>
		  ...
		  <td><center><a href='".$link."&aksi=hapus&id=".$id_produk."'><img src='img/icon/delete.png' title='Hapus'></a></center></td>";
	}
