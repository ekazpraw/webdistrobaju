...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="497" class="table" height="249" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <th height="25" colspan="4" align="center" bgcolor="#9E9A98" scope="col" valign="middle"><h2><strong class="judul-login">ADMINISTRATOR LOGIN</strong></h2></th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#DAD5D3">&nbsp;</td>
      <td style="padding-right:10px" align="right" bgcolor="#DAD5D3"><input type="submit" class="button green" name="login" id="login" value="Login"/></td>
    </tr>
    <tr>
      <td colspan="4" align="center" bgcolor="#DAD5D3"></td>
    </tr>
  </table>
</form>
<br>
	<div align="center"><font size="2" color="#272727"><em>* Powered by Hack The Brains & Blackmarket-ID.Corp *</em></font></td></div>
