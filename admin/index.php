...
<div class="banner">
	<img src="<?php echo ".".$banner_admin."" ?>" width="220px" height="40px">
</div>
...
<center>
	<font style="color:#888888"><?php echo "".$judul_web.""; $akhirload = microtime(true); $waktuload = $akhirload  - $awalload; ?> : Powered by Hack The Brains<?php  echo " - Page Load : " . number_format($waktuload, 3, '.', '') . " s"; ?></center>
	<br>
</div>
