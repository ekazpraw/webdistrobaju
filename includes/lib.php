...
// vMart //
define("Win_Merch", "1.0 Beta");
define("powered", "Powered by Hack The Brains, Versi ".Win.Merch."");
define("tahun", "2018");
{
...
{ 
	...
	$banner_admin=$row_pengaturan['banner_admin'];
...
$row_kontak=mysql_fetch_assoc($sql_kontak);
{
	...
	$instagram=$row_kontak['instagram'];
	$email_kontak=$row_kontak['email_kontak'];
}
