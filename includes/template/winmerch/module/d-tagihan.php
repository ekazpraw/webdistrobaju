...
<table width="560" height="404" cellpadding="0" cellspacing="0" style="border-style:solid; border-width:thin; border-color:#DFDFDF" >
  <tr>
    <td width="559" valign="top" scope="col"><table width="560" cellspacing="0" cellpadding="0" border="0">
      <tr>
        <th width="110" height="89" scope="col"><img src="<?php echo "".$banner_admin.""; ?>" width="200px" height="40px"></th>
...
<hr>
      <table width="560" cellpadding="0" cellspacing="1">
        <tr align="left">
          ...
          &nbsp;Tgl. Tagihan : <?php echo $tgl_sekarang ?>
          <br><br></td>
        </tr>
...
?>
		...
		<tr  bgcolor="#B7ECC4">
          <th height="5" colspan="6" align="left" ><h4>&nbsp;&nbsp;*Pembayaran melalui Rek. 123-00-0700821-4. Atas nama: Agus Budiman Putra</h4></th>
        </tr>
      </table>
<br>
  </td>
...
<p align="left">
*Untuk pembayaran saat ini hanya kepada "Via ATM Mandiri" kami saja.
</p>
<p align="right">
